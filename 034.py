...
# matplotlib 한글 폰트 오류 문제 해결 -> 근데 왜 깨지지 ?
...
ax.plot(deg, val1, linewidth=1, linestyle='solid', label='1st Team')
ax.fill(deg, val1, 'orange', alpha=0.2)

ax.plot(deg, val2, linewidth=1, linestyle='solid', label='10th Team')
